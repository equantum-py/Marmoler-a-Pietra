...
export async function Hero() {
  ...
  const desktopImage =
    banner.desktop_image_url || fallbackHomeBanner.desktop_image_url;

  const mobileImage =
    banner.mobile_image_url || desktopImage;

  const altText =
    banner.alt_text ||
    banner.name ||
    'Superficies premium de Marmolería Pietra';
    ...
    >
      <div className="home-banner">
        ...
        <div className="home-hero-content">
          ...
          >
            Superficies hechas para durar en cada proyecto.
          </h1>

          <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/90 sm:text-lg lg:text-xl">
            Diseñamos, fabricamos e instalamos mesadas de mármol,
            granito, cuarzo y Neolith en todo Paraguay.
          </p>
