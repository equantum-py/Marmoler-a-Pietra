  ...
  return (
    <section id="contacto" className="relative overflow-hidden bg-pietra-black py-24 text-center md:py-36">
      ...
      <div className="luxe-container relative">
        ...
        <WhatsappLink whatsappNumber={whatsappNumber} message="Hola Pietra, quiero transformar un espacio y necesito asesoramiento." className="mt-9 px-8 py-4">Hablar con un asesor</WhatsappLink>
      </div>
    </section>
  );
}
